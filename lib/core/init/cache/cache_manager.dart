...
class CacheManager {
  ...
  bool containsKey(PreferancesKeys key) =>
      _sharedPreferences!.containsKey(key.toString());

  String getStringValue(PreferancesKeys key) =>
      _sharedPreferences!.getString(key.toString()) ?? '';
  List<String>? getStringList(PreferancesKeys key) =>
      _sharedPreferences!.getStringList(key.toString());
  bool getBoolValue(PreferancesKeys key) =>
